...
<main class="min-h-screen bg-white">
    <div class="relative min-h-[70vh] flex items-center bg-[#003366] overflow-hidden pt-20">
        <div class="absolute inset-0">
            <img src="<?php echo e(asset('images/feedmill.jpeg')); ?>" class="w-full h-full object-cover opacity-40 scale-105">
        ...
        <div class="space-y-16">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative h-[350px] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-slate-50">
                    <img src="<?php echo e(asset('images/feed1.jpeg')); ?>" class="w-full h-full object-cover object-center hover:scale-110 transition-transform duration-700">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative pt-10 items-stretch">
                ...
                <div class="relative z-10 bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-50 flex flex-col items-center text-center group hover:border-[#0099ff] transition-all duration-500 h-full">
                    <div class="h-32 flex items-center justify-center mb-6 transform group-hover:scale-110 transition-transform duration-500 <?php echo e($item['size']); ?> filter drop-shadow-lg text-4xl">
                    ...
                    <h3 class="text-[#003366] font-black text-xl uppercase mb-2"><?php echo e($item['fase']); ?></h3>
        ...
        <div class="group flex flex-col lg:flex-row-reverse items-center gap-12 md:gap-20">
            <div class="w-full lg:w-1/2 relative">
                ...
                <div class="relative h-[500px] rounded-[2.5rem] overflow-hidden shadow-2xl">
                    <img src="<?php echo e(asset('images/feed2.jpeg')); ?>" class="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700">
                </div>
            </div>
            <div class="w-full lg:w-1/2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="p-6 bg-white rounded-2xl border-2 border-[#001AFF]/20 hover:bg-[#001AFF] hover:border-[#001AFF] hover:text-white transition-all duration-300 group flex flex-col items-center md:items-start text-center md:text-left shadow-sm">
                        <span class="text-2xl mb-2 block filter drop-shadow-sm"><?php echo e($item['icon']); ?></span>
                        <p class="text-[#001AFF] font-black text-xs uppercase mb-1 group-hover:text-white transition-colors"><?php echo e($item['fase']); ?></p>
                        <p class="text-sm italic text-gray-600 group-hover:text-blue-50 transition-colors"><?php echo e($item['range']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        ...
        <div class="space-y-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                <?php $__currentLoopData = [
                    ...
                    ['name' => 'Babi', 'icon' => '🐖'],
                    ['name' => 'Sapi', 'icon' => '🐄']
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ternak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\OneMoreLightLP\resources\views/public/content/PakanTernak.blade.php ENDPATH**/ ?>