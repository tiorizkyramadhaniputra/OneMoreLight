            ...
            <nav class="hidden lg:flex items-center gap-8">
                <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        @mouseenter="activeMenu = '<?php echo e($item['label']); ?>'"
                    ...
                    >
                        <a
                            ...
                            :class="activeMenu === '<?php echo e($item['label']); ?>' ? 'text-[#FFD700]' : 'text-white'"
                        >
                            ...
                            <?php if(count($item['columns']) > 0): ?>
                                <div 
                                    class="transition-transform duration-300"
                                    :class="activeMenu === '<?php echo e($item['label']); ?>' ? 'rotate-180' : 'rotate-0'"
                                >
                                    <!-- ChevronDown Icon -->
                        ...
                        <?php if(count($item['columns']) > 0): ?>
                            <div
                                x-show="activeMenu === '<?php echo e($item['label']); ?>'"
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $item['columns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex flex-col gap-3">
                                        <?php $__currentLoopData = $col['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a
                                                href="<?php echo e($subItem['href']); ?>"
                                            ...
                                            >
                                                <div class="flex items-center gap-2 text-[14px] text-gray-600 transition-colors duration-200 group-hover/item:text-[#001EF2] hover:translate-x-1.5 transition-transform">
                                                    ...
                                                    <span class="font-medium"><?php echo e($subItem['label']); ?></span>
                                                </div>
                                            </a>
        ...
        <div class="flex flex-col gap-6 pb-10">
            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="border-b border-gray-100 pb-4">
                    <div class="font-bold text-[#001EF2] mb-3"><?php echo e($item['label']); ?></div>
                    <div class="grid grid-cols-1 gap-2 pl-4">
                        ...
                        <?php $__currentLoopData = $allItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a
                                href="<?php echo e($subItem['href']); ?>"
...
<?php /**PATH /Users/macbookair/PrjctCharoen/Charoen/resources/views/public/partials/navbar.blade.php ENDPATH**/ ?>