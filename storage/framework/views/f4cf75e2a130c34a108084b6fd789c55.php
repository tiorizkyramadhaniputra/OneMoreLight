        ...
        <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div class="w-full lg:w-1/2 relative">
                ...
                <div class="relative z-10 rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] group">
                    <img 
                        src="<?php echo e(asset('images/karosel1cp.jpeg')); ?>" 
                        alt="Visi Misi PT Charoen Pokphand Indonesia Tbk" 
                ...
                <div class="absolute -bottom-6 -right-4 lg:-right-8 bg-white p-6 rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border-l-4 border-[#FFD700] max-w-[280px] z-20 hidden md:block">
                    <p class="font-bold text-[#001EF2] text-xl mb-1">Sejak 1972</p>
                    <p class="text-sm text-gray-600 leading-snug">Berdedikasi dalam industri pakan ternak dan pembibitan ayam ras di Indonesia.</p>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/2">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4">Memproduksi dan menjual produk berkualitas tinggi dan berinovasi yang meliputi:</p>
                        <ul class="space-y-4">
...
<?php /**PATH /Users/macbookair/OneMoreLightLP/Charoen/resources/views/sections/vision-mission.blade.php ENDPATH**/ ?>